...
public class TripController {
    ...
    public ResponseEntity<List<Trip>> getTripsByStartTime(@PathVariable String dateFrom, String dateTo){
        return ResponseEntity.ok(tripService.getTripsByStartTime(dateFrom, dateTo));
    }
}
